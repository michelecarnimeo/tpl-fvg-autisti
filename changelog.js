...
const changelogData = [
  {
    ...
    time: '16:00',
    title: 'Controlli mappa avanzati + Geolocalizzazione migliorata + Prototipi iOS 26 (v1.8.8)',
    hidden: false,
    changes: [
      '🗺️ CONTROLLI MAPPA AVANZATI:',
      '  • Menu dimensioni mappa con 4 opzioni: piccola, media, grande, fullwidth',
      '  • Posizionamento dinamico menu sopra/sotto in base a spazio viewport disponibile',
      '  • Pulsanti aggiuntivi: Centra (centra mappa su fermate), Posizione (centra su posizione utente), Fermate (toggle sidebar)',
      '  • Modalità satellite/mappa standard con toggle',
      '  • Gestione completa accessibilità: aria-haspopup, aria-expanded, role menu, role menuitem',
      '  • Fix z-index per menu dimensioni (position relative su line-map-column)',
      '  • Gestione stato menu con flag justOpened per prevenire chiusura immediata',
      '  • Event handlers per click outside e Escape key',
      '  • +768 righe in line-map.js, +623 righe in line-map.css',
      '📍 GEOLOCALIZZAZIONE MIGLIORATA:',
      '  • Reverse geocoding con Nominatim (OpenStreetMap) per ottenere nome città da coordinate',
      '  • Cache in-memory per reverse geocoding (evita chiamate duplicate)',
      '  • Calcolo distanze reali lungo strade usando OSRM (Open Source Routing Machine)',
      '  • Gestione errori migliorata con timeout e AbortController',
      '  • Supporto coordinate reali per fermate (da coordinates-linea-400.js)',
      '  • Funzione calculateRealDistances con retry logic (max 2 tentativi)',
      '  • Fallback a distanza Haversine se OSRM non disponibile',
      '  • +472 righe in geolocation.js',
      '🎨 PROTOTIPI iOS 26:',
      '  • home-ios26-prototype.html: Design moderno con 3 step (Linea, Percorso, Codice)',
      '  • Animazioni velocizzate (da 0.6s a 0.4s, da 0.5s a 0.35s)',
      '  • Badge indicatore sezione "Home • Codici & Linee" in tutti gli step',
      '  • Pulsanti partenza/destinazione più sottili (padding verticale 1rem invece di 1.5rem)',
      '  • Menu mobile riorganizzato (pulsante tema spostato nel menu)',
      '  • Pulsante hamburger ottimizzato secondo best practice UI/UX',
      '  • Progress bar con navigazione drag-and-drop tra step',
      '  • Toast notifications iOS-style',
      '  • Modal bottom sheet per selezione fermate',
      '  • fermate-ios26-prototype.html: Layout ottimizzato per mobile, progress bar integrata',
      '  • welcome-ios26-prototype.html: Pagina benvenuto con design iOS 26',
      '✨ MIGLIORAMENTI UI/UX:',
      '  • Menu mobile (mobile-menu.css): Stili iOS 26, animazioni smooth, overlay migliorato',
      '  • Modali (modals.css): Ottimizzazioni simmetria, padding uniforme, scrollbar nascosta',
      '  • GPS Debug Panel (gps-debug-panel.css): Stili draggable, minimizzabile, posizione persistente',
      '  • Fermate card (fermate-card.css): +68 righe, miglioramenti responsive',
      '  • Fermate modal (fermate-modal.css): Miglioramenti layout e animazioni',
      '  • Footer: Layout responsive migliorato, badge Telegram con stile pill',
      '⚡ OTTIMIZZAZIONI E REFACTORING:',
      '  • page-renderers.js: Refactoring codice, -176 righe, logica ottimizzata',
      '  • fermate-accordion.js: Miglioramenti gestione accordion mobile',
      '  • modals.js: +86 righe, miglioramenti gestione modali',
      '  • test-mode.js: Miglioramenti modalità test globale',
      '  • Ottimizzazioni performance CSS (animazioni con pseudo-elementi)',
      '  • Miglioramenti accessibilità (ARIA attributes, focus management)',
      '  • Fix layout responsive su varie pagine',
      '📦 NUOVI FILE:',
      '  • css/components/app-loader.css: Loader applicazione',
      '  • js/components/app-loader.js: Logica loader applicazione',
      '  • js/debug/home-debug-buttons.js: Pulsanti debug per home page',
      '  • prototipi/home-ios26-prototype.html: Prototipo home iOS 26',
      '  • prototipi/fermate-ios26-prototype.html: Prototipo fermate iOS 26',
      '  • prototipi/welcome-ios26-prototype.html: Prototipo welcome iOS 26',
      '📊 STATISTICHE:',
      '  • 33 file modificati',
      '  • +9,911 righe aggiunte',
      '  • -743 righe rimosse',
