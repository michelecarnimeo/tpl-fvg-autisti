...
.dark-mode-toggle:hover {
  background-color: rgba(
    ...
    255,
    0.1
  ); /* Sfondo bianco trasparente al hover */
}
```
...
.swap-btn:hover {
  ...
  box-shadow: 0 15px 35px rgba(0, 0, 0, 0.15), /* Ombra più forte */ 0 5px 15px
      rgba(23, 183, 177, 0.3); /* Ombra turchese */
  border-color: rgba(23, 183, 177, 0.5); /* Bordo turchese */
  background: rgba(255, 255, 255, 0.35); /* Sfondo più opaco */
}
```
...
.dark .form-select {
  color: rgba(
    ...
    252,
    0.95
  ); /* Testo chiaro con 95% opacità in dark mode */
}
```
...
.dark .tratte-card h3 {
  ...
  border-bottom-color: rgba(
    ...
    255,
    0.3
  ); /* Bordo inferiore bianco trasparente */
...
.dark .form-label {
  color: rgba(
    ...
    240,
    0.9
  ); /* Testo grigio molto chiaro con 90% opacità */
...
.dark .tratte-item:hover {
  background: rgba(
    ...
    177,
    0.4
  ); /* Sfondo turchese trasparente al hover */
  ...
  border-color: rgba(
    ...
    196,
    0.5
  ); /* Bordo turchese più chiaro al hover */
}
```
...
.dark .tratte-list::-webkit-scrollbar-thumb {
  background: rgba(
    ...
    177,
    0.6
  ); /* Sfondo turchese trasparente per il thumb */
}
```
...
## 📚 **SEZIONE 12: ALTRI ELEMENTI**

Nota: la sezione Cronologia è stata rimossa dall'app e dagli stili.
...
.line-search-container select {
  background: rgba(
    ...
    255,
    0.25
  ) !important; /* Sfondo bianco trasparente forzato */
...
#linea-tariffe:focus {
  ...
  background: rgba(
    ...
    255,
    0.35
  ) !important; /* Sfondo più opaco forzato */
}
```
...
.dark .line-search-container select {
  background: rgba(
    ...
    59,
    0.3
  ) !important; /* Sfondo scuro trasparente forzato */
...
.dark #linea-tariffe:focus {
  ...
  background: rgba(
    ...
    59,
    0.4
  ) !important; /* Sfondo scuro più opaco forzato */
}
```
...
_Documentazione generata automaticamente per il progetto TPL FVG Autisti v0.8 build 21_
